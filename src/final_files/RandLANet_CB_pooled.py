...
def test_model():
    ...
    dummy = torch.randn(B, N, model_config['d_in'])
    # model = RandLANet.from_config_file("src/final_files/RandLANet15.json", n_classes=n_classes)
    model = RandLANet(model_config, n_classes=n_classes)
